    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      ...
      >
        <div className="p-8 sm:p-12">
          ...
          <h2 className="text-3xl font-bold text-center text-slate-900 mb-2">Xush kelibsiz</h2>
          <p className="text-center text-slate-500 mb-8">Tizimga kirish uchun ma'lumotlaringizni kiriting</p>
